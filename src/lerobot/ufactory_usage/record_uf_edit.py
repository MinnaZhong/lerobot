...
def main():
    cfg_yaml_file = "xarm7_gello_record_config.yaml"
    # cfg_yaml_file = "xarm7_spacemouse_record_config.yaml"
    with open(cfg_yaml_file, 'r') as f:
        cfg = yaml.safe_load(f)
    confile = instantiate_from_dict(cfg)
    print(confile) # dict of items with keys(from config file) and real objects as values
    
    resume = False # Continue recording on an existing dataset
